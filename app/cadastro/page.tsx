        ...
        {database.settings.map(settings => (
          <div className="mx-auto h-10 w-50" key={settings.Companytitle}>
            ...
            <div className="flex mt-2 flex-wrap justify-center items-center flex-col">
              <span className="font-medium text-3xl">Cadastro de Interessados</span>
              <span className="font-medium text-lg">Agradecemos seu interesse em nossos cursos. Por favor informe os dados abaixo</span>
            </div>
            <div className="mt-4">
              <form className="max-w-md mx-auto">
                <span className="font-medium text-lg ">Dados De Contato</span>
